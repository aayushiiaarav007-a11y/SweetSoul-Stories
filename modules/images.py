"""
Image fetching for SweetSoul Stories: Pexels PHOTOS and keyless Picsum images.
...
log = logging.getLogger("sweetsoul.images")
...
def fetch_picsum_images(keywords, count=None):
    ...
    os.makedirs(IMAGES_DIR, exist_ok=True)
    base = "-".join(keywords) if keywords else "sweetsoul"
    collected = []
