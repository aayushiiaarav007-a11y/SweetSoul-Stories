#!/usr/bin/env python3
"""
Upload generated MoralTales episodes to YouTube.
...
log = logging.getLogger("moraltales.upload")
...
def main(argv=None):
    parser = argparse.ArgumentParser(description="Upload MoralTales episodes to YouTube.")
