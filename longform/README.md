...
> Separate from the SweetSoul reels/shorts pipeline - this repo has its own
...
> upload) comfortable when this shares a channel with the SweetSoul reels,
> 4 reels + 1 long-form = ~8,000 units/day, which stays safely under the cap.

## Run it manually

GitHub: **Actions -> MoralTales Auto Longform -> Run workflow**
